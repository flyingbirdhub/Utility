package entity.convertMethod.noneStatic.others;

import convert.PropertyConvertNoStaticUtil;
...
public class UserProtocol {
    ...
    @AliasField(name={"userId"}, methodClass = PropertyConvertNoStaticUtil.class, methodName = "String2Int", parameters = {String.class})
    private long selfId;
