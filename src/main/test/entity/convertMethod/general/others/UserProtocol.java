package entity.convertMethod.general.others;

import convert.PropertyConvertUtil;
...
public class UserProtocol {
    ...
    @AliasField(name={"userId"}, methodClass = PropertyConvertUtil.class, methodName = "String2Int", parameters = {String.class})
    private long selfId;
